...
public class AbvMailboxWithRecepientAndSubjectOnly {
	...
	public static void main(String[] args) {
		WebDriver driver = new FirefoxDriver();
	      ...
	      // assertEquals(sendingMessageResult, "Писмото беше изпратено успешно!"); 
	      
	      // Close the Browser.
	      driver.close();
	}

	public static void confirmSending(WebDriver driver) {
		  WebElement sendingConfirmationMessage = driver.findElement(By.xpath("//*[contains(text(), 'Писмото беше изпратено успешно!')]"));
